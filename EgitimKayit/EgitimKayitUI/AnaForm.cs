...
namespace EgitimKayitUI
{
    public partial class AnaForm : Form
    {
        ...
        private void ogretmenlerToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frm_Ogretmenler frm_Ogretmenler = new frm_Ogretmenler();
            frm_Ogretmenler.Show();
        }

        private void şubelerToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frm_Subeler frm_Subeler = new frm_Subeler();
            frm_Subeler.Show();
        }
    }
}
