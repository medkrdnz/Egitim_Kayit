...
namespace EgitimKayitUI
{
    public partial class frm_Ogrenciler : Form
    {
        ...
        {
             bs.DataSource=Program.isBirimi.OgrenciGetir();
        ...
        {
            frm_OgrenciDuzenle frm_OgrenciDuzenle = new frm_OgrenciDuzenle(dgvOgrenciler.SelectedRows[0].Cells["Col_Id"].Value.ToString());
